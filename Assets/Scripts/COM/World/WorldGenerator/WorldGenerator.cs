...
namespace COM.World
{
    public class WorldGenerator : MonoBehaviour
    {
        ...
        {
            mat.SetTexture("_SurfaceRegions", SurfaceRegionEncoder.CreateTexture(Run.instance.SurfaceBiomes));
            mat.SetTexture("_CaveRegions", CaveRegionEncoder.CreateTexture(Run.instance.CaveBiomes));
            mat.SetTexture("_RegionMap", RegionMapEncoder.CreateTexture(Regions));
        }
        #endregion
